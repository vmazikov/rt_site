...
// 3) Адрес не определён (null, undefined и т.д.)
        ...
        <div class="popup-card__item-container">
          <div class="popup-card__container-items">
            <div class="popup-card__item-section">
              <img class="popup-card__item-img" src="${internetIcon}" alt="">
              <h3 class="popup-card__item-title">Интернет: <span class="popup-card__item-title_speed">${tariffData.speed}</span> Мбит/с</h3>
              <img class="popup-card__item-button-arrow" src="${downArrow}" alt="">
            </div>
            <span class="popup-card__item-title-span"></span>
            <div class="popup-card__item-content">
              <div class="popup-card__item-content-additional">
                <span class="popup-card__item-content-additional-item">Скорость:</span>
                <span class="popup-card__item-content-additional-item">
                  <span class="popup-card__item-content-additional-item_speed">${tariffData.speed}</span> Мбит/с
                </span>
              </div>
              <div class="popup-card__item-content-additional">
                <span class="popup-card__item-content-additional-item">Технология подключения:</span>
                <span class="popup-card__item-content-additional-item popup-card__item-content-additional-item_technology">
    ...
    itemsHTML += `
      <div class="popup-card__item popup__item_tv">
        <div class="popup-card__item-container">
          <div class="popup-card__container-items">
            <div class="popup-card__item-section">
              <img class="popup-card__item-img" src="${tvCardIcon}" alt="">
              <h3 class="popup-card__item-title">ТВ: <span class="popup-card__item-title_channels">${tariffData.channels}</span> Каналов</h3>
              <img class="popup-card__item-button-arrow" src="${downArrow}" alt="">
            </div>
            <span class="popup-card__item-title-span"></span>
            <div class="popup-card__item-content">
              <div class="popup-card__item-content-additional">
                <span class="popup-card__item-content-additional-item">ТВ каналы:</span>
                <span class="popup-card__item-content-additional-item popup-card__item-content-additional-item_channels">${tariffData.channels}</span>
              </div>
              <div class="popup-card__item-content-additional">
                <span class="popup-card__item-content-additional-item">Архив ТВ-каналов:</span>
                <span class="popup-card__item-content-additional-item">72 часа</span>
              </div>
              <div class="popup-card__item-content-additional">
                <span class="popup-card__item-content-additional-item">
    ...
    itemsHTML += `
      <div class="popup-card__item popup-card__item_mobile">
        <div class="popup-card__item-container">
          <div class="popup-card__container-items">
            <div class="popup-card__item-section">
              <img class="popup-card__item-img" src="${smartphoneIcon}" alt="">
              <h3 class="popup-card__item-title">
                Связь: <span class="popup-card__item-title_sim">
            ...
            <div class="popup-card__item-content">
              <div class="popup-card__item-content-additional">
                <span class="popup-card__item-content-additional-item">Минуты:</span>
                <span class="popup-card__item-content-additional-item popup-card__item-content-additional-item_min">${tariffData.sim_description.min}</span>
              </div>
              <div class="popup-card__item-content-additional">
                <span class="popup-card__item-content-additional-item">ГБ:</span>
                <span class="popup-card__item-content-additional-item popup-card__item-content-additional-item_gb">${tariffData.sim_description.gb}</span>
              </div>
              <div class="popup-card__item-content-additional">
                <span class="popup-card__item-content-additional-item">СМС:</span>
                <span class="popup-card__item-content-additional-item popup-card__item-content-additional-item_sms">${tariffData.sim_description.sms}</span>
              </div>
              <div class="popup-card__item-content-additional">
                <span class="popup-card__item-content-additional-item">Количество Сим:</span>
                <span class="popup-card__item-content-additional-item popup-card__item-content-additional-item_count-sim">${tariffData.sim_cards}</span>
              </div>
              <div class="popup-card__item-content-additional">
                <span class="popup-card__item-content-additional-item">
                  <img class="card__additional-info-img" src="${checkIcon}">
    ...
    itemsHTML += `
      <div class="popup-card__item popup-card__item_wink">
        <div class="popup-card__item-container">
          <div class="popup-card__container-items">
            <div class="popup-card__item-section">
              <img class="popup-card__item-img" src="${winkIcon}" alt="">
              <h3 class="popup-card__item-title">Wink</h3>
              <img class="popup-card__item-button-arrow" src="${downArrow}" alt="">
            </div>
            <span class="popup-card__item-title-span">${tariffData.wink_description}</span>
            <div class="popup-card__item-content">
              <div class="popup-card__item-content-additional">
                <span class="popup-card__item-content-additional-item">
    ...
    itemsHTML += `
      <div class="popup-card__item popup-card__item_games">
        <div class="popup-card__item-container">
          <div class="popup-card__container-items">
            <div class="popup-card__item-section">
              <img class="popup-card__item-img" src="${gameIcon}" alt="">
              <h3 class="popup-card__item-title">Игровые опции</h3>
              <img class="popup-card__item-button-arrow" src="${downArrow}" alt="">
            </div>
            <span class="popup-card__item-title-span"></span>
            <div class="popup-card__item-content">
    ...
    itemsHTML += `
      <div class="popup-card__item popup-card__item_video">
        <div class="popup-card__item-container">
          <div class="popup-card__container-items">
            <div class="popup-card__item-section">
              <img class="popup-card__item-img" src="${videoIcon}" alt="">
              <h3 class="popup-card__item-title">Видеонаблюдение</h3>
              <img class="popup-card__item-button-arrow" src="${downArrow}" alt="">
            </div>
            <span class="popup-card__item-title-span"></span>
            <div class="popup-card__item-content">
              <div class="popup-card__item-content-additional">
                <span class="popup-card__item-content-additional-item">Количество камер:</span>
                <span class="popup-card__item-content-additional-item">${tariffData.video}</span>
              </div>
              <div class="popup-card__item-content-additional">
                <span class="popup-card__item-content-additional-item">Количество дней хранения:</span>
                <span class="popup-card__item-content-additional-item">7</span>
              </div>
              <div class="popup-card__item-content-additional">
                <span class="popup-card__item-content-additional-item">
          ...
          <div class="popup-card__item popup-card__item_router">
            <div>
              <div class="popup-card__item-container">
                <div class="popup-card__container-items">
                  <div class="popup-card__item-section">
                    <img class="popup-card__item-img" src="${routerIcon}" alt="Интернет">
                    <span class="popup-card__item-title">Wi-Fi роутер</span>
                    <label class="popup-card__item-label">
                      <input type="checkbox" class="popup__toggle" id="wifi-router" checked>
                      <span class="popup__toggle-label"></span>
                    </label>
                  </div>
                  <span class="popup-card__item-title-span"></span>
                </div>
          ...
          <div class="popup-card__item popup-card__item_tv-box">
            <div>
              <div class="popup-card__item-container">
                <div class="popup-card__container-items">
                  <div class="popup-card__item-section">
                    <img class="popup-card__item-img" src="${tvBoxIcon}" alt="">
                    <span class="popup-card__item-title">ТВ-приставка</span>
                    <label class="popup-card__item-label">
                      <input type="checkbox" class="popup__toggle" id="tv-box">
                      <span class="popup__toggle-label"></span>
                    </label>
                  </div>
                  <span class="popup-card__item-title-span">Для просмотра ТВ-каналов на некоторых телевизорах</span>
                </div>
              </div>
            </div>
          </div>
  ...
  function setupEquipmentSelection(tariffData) {
    const pricingContainer = document.querySelector('.popup-card__pricing-detail-equipment'); // Контейнер с ценами
        ...
        if (routerToggle && routerToggle.checked) {
            ...
            pricingContainer.innerHTML += `
                <div class="popup-card__pricing-detail" id="router-price">
                  <span class="popup-card__pricing-subtitle">${routerTitle}</span>
                  <span class="popup-card__pricing-value">${routerPrice}</span>
                </div>
            `;
        }
        ...
        if (tvBoxToggle && tvBoxToggle.checked) {
            ...
            pricingContainer.innerHTML += `
                <div class="popup-card__pricing-detail" id="tv-box-price">
                  <span class="popup-card__pricing-subtitle">ТВ приставка</span>
                  <span class="popup-card__pricing-value">${tvBoxPrice}</span>
                </div>
            `;
        }
    }
  ...
  const pricingPriceEl = popup.querySelector('.popup-card__pricing-price');
  const pricingDiscountEl = popup.querySelector('.popup-card__pricing-discount');
  const pricingPriceAfterEl = popup.querySelector('.popup-card__pricing-price_after');
  ...
  if (tariffData.price_after_promo) {
    ...
    pricingPriceAfterEl.innerHTML = `<span class="popup-card__pricing-price_after_bold">${tariffData.price_after_promo} ₽/мес</span> с ${nextMonth}-го месяца`;
  } else {
    pricingPriceEl.textContent = `${tariffData.price_promo} ₽/мес`;
  ...
  popup.querySelectorAll('.popup-card__item-container').forEach(container => {
    container.addEventListener('click', () => {
      ...
      const arrow = item.querySelector('.popup-card__item-button-arrow');
      const label = item.querySelector('.popup__toggle-label');
      
      if (!content || !arrow) return;
      
      // Переключаем класс для открытия/закрытия содержимого секции
      content.classList.toggle('popup-card__item-content_active');
      arrow.classList.toggle('popup-card__item-button-arrow_active');
